# The live Slack verification run
...
[ADR 0008](../adr/0008-slack-update-in-place-primary.md) makes load-bearing, an
...
[ADR 0020](../adr/0020-broadcast-the-transitions-that-must-be-seen.md) Amendment 4
