...
| The payload version is newer than this binary | `permanent` | `unknown_payload_version` — also on [`oto_jobs_unknown_version_total`](oto_jobs_unknown_version_total.md) |
