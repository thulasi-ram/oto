# oto_stream_poll_recovered_total
...
- **notifications are being missed** — check
  [`oto_stream_listener_reconnects_total`](oto_stream_listener_reconnects_total.md) and
  [`oto_stream_notify_malformed_total`](oto_stream_notify_malformed_total.md); or
...
1. Compare with [`oto_stream_notify_received_total`](oto_stream_notify_received_total.md). Poll
