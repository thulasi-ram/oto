...
- Explaining [`oto_stream_events_dropped_total`](oto_stream_events_dropped_total.md) and
  [`oto_stream_resync_total`](oto_stream_resync_total.md) — drops per connection is the meaningful
