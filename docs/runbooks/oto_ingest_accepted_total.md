...
**not** counted here — it lands on [`oto_ingest_duplicate_total`](oto_ingest_duplicate_total.md).
...
3. Is anything else refusing the batch first — [`oto_ingest_shed_total`](oto_ingest_shed_total.md)
   (503s) or [`oto_ingest_rejected_total`](oto_ingest_rejected_total.md) with
