...
- **Large negative** (upstream ahead of oto): timestamps in the future. B12/B13 turn the extreme
  ...
  [`oto_ingest_rejected_total`](oto_ingest_rejected_total.md) — B12 drops the alert, B13 clamps and
...
3. `timestamp_out_of_window` on [`oto_ingest_rejected_total`](oto_ingest_rejected_total.md) — if it
