...
1. [`oto_job_queue_depth`](oto_job_queue_depth.md) for `queue="ingest"`, `state="available"` — the
...
3. [`oto_ingest_process_duration_seconds`](oto_ingest_process_duration_seconds.md): are batches
