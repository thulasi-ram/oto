# oto_stream_notify_received_total
...
[`oto_stream_poll_recovered_total`](oto_stream_poll_recovered_total.md) (the poll doing more work
than it should) rather than this counter going quiet.

Useful comparisons:

- Flat while [`oto_stream_events_fetched_total`](oto_stream_events_fetched_total.md) climbs → the
  LISTEN connection is not delivering; check
  [`oto_stream_listener_reconnects_total`](oto_stream_listener_reconnects_total.md).
