# 0015 — No stream processor; River in Postgres is the pipeline

**Status:** Accepted · 2026-08-08
**Relates to:** [0001](0001-postgres-sole-datastore-river-job-queue.md) (River and the transactional
outbox), [0014](0014-postgres-only-no-analytical-store.md) (one datastore)
...
[0001](0001-postgres-sole-datastore-river-job-queue.md): either the occurrence opened and the
...
recompile — embedding Bloblang (or CEL, per [0017](0017-matchers-over-cel.md)) gives us that with no
...
- Throughput is bounded by Postgres and by River's worker pool rather than by a purpose-built stream
  engine. This is acceptable at the volumes established in [0014](0014-postgres-only-no-analytical-store.md).
