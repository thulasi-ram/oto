# 0037 — The card's shape is oto's, and the knobs over it are typed

**Status:** Proposed · 2026-08-18 · awaiting ratification; amends SPEC §L.5.1, §H.1, §H.3, §I.1
**Relates to:** [0008](0008-slack-update-in-place-primary.md) (the card's structure and why a broken
layout is a dead delivery), [0017](0017-matchers-over-cel.md) (the standing refusal of an expression
language), [0020](0020-broadcast-the-transitions-that-must-be-seen.md) (the typed-knob precedent, and
