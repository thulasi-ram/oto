# 0022 — Length-prefixed identity pre-images

**Status:** Accepted · 2026-08-09
**Amends:** [0004](0004-alert-identity-key-and-fingerprint.md) (which specified the `0x00` framing),
SPEC §C.0–§C.7
**Relates to:** [0021](0021-correctness-and-testing-strategy.md) (the tests that found this)
