# 0027 — Delivery drills: a synthetic alert through the real pipeline, and the mark that keeps it out of the numbers

**Status:** Accepted · 2026-08-09
**Decided WITHOUT the owner.** See *How to overturn this*, below.
**Relates to:** [0024](0024-retention-defaults-and-cold-storage.md) (what retention deletes, and the
row-level prunes this joins), [0009](0009-rule-snapshot-versioning-at-fire-time.md) (why the
rule-snapshot stage may honestly skip), [0013](0013-alert-first-scope-boundary.md) (FR-1),
[0014](0014-postgres-only-no-analytical-store.md) (why `alert_quality_daily` exists at all)
