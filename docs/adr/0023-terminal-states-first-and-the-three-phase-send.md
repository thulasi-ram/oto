# 0023 — Terminal thread states are decided first, and the send is three phases
...
**Relates to:** [0005](0005-durable-group-key-owns-the-slack-thread.md) (the thread a generation owns),
[0008](0008-slack-update-in-place-primary.md) (update-in-place, which is why a duplicate root is the
expensive failure), [0021](0021-correctness-and-testing-strategy.md) (the audit that found both)
