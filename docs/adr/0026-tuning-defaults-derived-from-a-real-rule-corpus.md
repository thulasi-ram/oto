...
[0005](0005-durable-group-key-owns-the-slack-thread.md) (why a closed generation means a new thread),
[0024](0024-retention-defaults-and-cold-storage.md) (the same "decided without the owner, derived not
chosen" shape)
