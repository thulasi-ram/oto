# 0017 — Alertmanager-style matchers, not CEL; and a filter AST that keeps the door open

**Status:** Accepted · 2026-08-08
**Relates to:** [0013](0013-alert-first-scope-boundary.md) (policies route signals, never people),
[0014](0014-postgres-only-no-analytical-store.md) (indexed queries are what make Postgres-only work)
...
- Every filter is index-backed, so search latency stays predictable as the event table grows — which is
  one of the load-bearing assumptions of [0014](0014-postgres-only-no-analytical-store.md).
