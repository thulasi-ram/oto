# 0029 — Type and radius scales, read off the product rather than drawn for it
...
worst outcome"*.
**Relates to:** [0012](0012-pastel-chrome-saturated-state.md) (the two-tier palette — the axis that
