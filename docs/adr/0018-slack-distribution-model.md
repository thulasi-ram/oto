# 0018 — Slack distribution: a customer-built internal app, credentials in config

**Status:** Accepted · 2026-08-08
**Relates to:** [0008](0008-slack-update-in-place-primary.md) (`chat.update` is the primary verb, and
oto never reads Slack back), [0013](0013-alert-first-scope-boundary.md) (oto tells the thing that
