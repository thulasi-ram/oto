# 0016 — Cluster context arrives via MCP, on demand; never the Kubernetes event firehose

**Status:** Accepted · 2026-08-08
**Relates to:** [0014](0014-postgres-only-no-analytical-store.md) (this is the rule that protects it),
...
This is the rule that keeps [0014](0014-postgres-only-no-analytical-store.md) true. Every argument for
...
breach [0013](0013-alert-first-scope-boundary.md): a k8s Event stream is not a fact about a signal we
