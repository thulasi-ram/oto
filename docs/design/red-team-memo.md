...
> the licence by [0019](../adr/0019-mit-licence.md), Kubernetes enrichment by
> [0016](../adr/0016-mcp-enrichment-no-firehose.md), Slack distribution by
> [0018](../adr/0018-slack-distribution-model.md). Where this memo and
> [SPEC.md](SPEC.md) disagree, the SPEC wins; it sits below the SPEC and above
