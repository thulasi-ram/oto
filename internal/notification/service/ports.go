...
type DeliveryStore interface {
	...
	PersistRendered(ctx context.Context, s db.TenantScope, id uuid.UUID, payload json.RawMessage, hash, fallback string, now time.Time, attr domain.RenderAttribution) error
