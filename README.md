...
![The case queue](docs/assets/screenshots/cases.png)
...
![A single case in detail](docs/assets/screenshots/case-detail.png)

**Rule drift.** The same alert, two episodes, two different rules — which is the whole
reason this project exists.

![Alert detail showing rule drift](docs/assets/screenshots/alert-detail.png)

**The delivery log.** Who was told, where, and whether it actually arrived. Failures are
visible rather than swallowed.

![The notification activity log](docs/assets/screenshots/notification-activity.png)
...
capture what a rule said at the moment it fired ([ADR 0009](docs/adr/0009-rule-snapshot-versioning-at-fire-time.md)).

## Concepts

Six nouns carry the whole model. [`docs/concepts.md`](docs/concepts.md) is the full
...
[ADR 0013](docs/adr/0013-alert-first-scope-boundary.md) and
[`docs/design/SCOPE-BOUNDARY.md`](docs/design/SCOPE-BOUNDARY.md), which adjudicates 32
...
Postgres subchart — see ADRs [0001](docs/adr/0001-postgres-sole-datastore-river-job-queue.md) and
[0014](docs/adr/0014-postgres-only-no-analytical-store.md).

## Where to read next

| | |
|---|---|
| [`docs/concepts.md`](docs/concepts.md) | The domain model in full: every noun, the state machines, worked examples. **Start here.** |
| [`CONTEXT.md`](CONTEXT.md) | Implementer's map: domain language, module map, layering rules. |
| [`CONTRIBUTING.md`](CONTRIBUTING.md) | Setup, the task runner, what each gate catches, how to read a red one. |
| [`docs/setup/configuration.md`](docs/setup/configuration.md) | Every environment variable, its default, and whether it is required. |
...
MIT — see [`LICENSE`](LICENSE) and [ADR 0019](docs/adr/0019-mit-licence.md). No `ee/`
