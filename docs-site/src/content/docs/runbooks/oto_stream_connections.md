...
- Explaining [`oto_stream_events_dropped_total`](/oto/runbooks/oto_stream_events_dropped_total/) and
  [`oto_stream_resync_total`](/oto/runbooks/oto_stream_resync_total/) — drops per connection is the meaningful
