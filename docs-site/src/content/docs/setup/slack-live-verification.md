...
1. Install the app and invite it: [slack.md sections 1–3 and 6](/setup/slack/). Use a
...
[Block Kit Builder cannot show](/setup/slack/#81-five-minutes-no-workspace-admin-needed-block-kit-builder).
...
- **[slack.md](/setup/slack/)**: anything in section 8 or in Troubleshooting that turned
...
none has an offline test; [slack.md §8.4](/setup/slack/#84-what-is-still-unverifiable-after-all-of-the-above)
